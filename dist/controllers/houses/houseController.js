...
export const getHouse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const house = yield House.findById(req.params.id);
    if (house) {
...
export const updateHouse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const house = yield House.findByIdAndUpdate(req.params.id, req.body);
        if (!house)
...
export const deleteHouse = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const house = yield House.findByIdAndDelete(req.params.id);
        if (!house)
...
export const searchHousesByName = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const housesSearchedByNames = yield House.find({ name });
