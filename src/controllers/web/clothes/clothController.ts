...
import { Cloth } from "../../../models/clothes/Cloth";
import { User } from "../../../models/users/user";
import multer from "multer";
import { Electronic } from "../../../models/electronics/Electronic";
import { Error } from "mongoose";
import {Request,Response} from "express";

export const createWebCloth = async (req:Request, res:Response) => {
  try {
...
export const getWebClothes = async (req:Request, res:Response) => {
  try {
    const clothes = await Cloth.find();
    res.render("../../../views/clothsView/index.ejs", clothes)
  } catch (error) {
    res.status(500).json({ message: "Något gick fel" });
  }
};

export const getWebCloth = async (req:Request, res:Response) => {
...
export const updateWebCloth = async (req:Request, res:Response) => {
  try {
...
export const deleteWebCloth = async (req:Request, res:Response) => {
  try {
...
export const getWebClothesWithPagination = async (req:Request, res:Response) => {
  try {
...
export const searchWebClothesByName = async (req:Request, res:Response) =>{
  try {
...
//high price
export const searchWebClothesByHighPrice = async (req:Request, res:Response) =>{
  try{
    const clothes = await  Cloth.find();
...
//search by low price
export const searchWebClothesByLowPrice = async (req:Request, res:Response) =>{
  try{
